...
<?php
    ...
    $strSQL = "SELECT `location_fail`.`id_mat`, `location_fail`.`id_store`, `store`.`storename` , `location_fail`.`id_shelf`, `shelf`.`name`, `location_fail`.`amount`
    FROM `location_fail`
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <!-- END BREADCRUMB-->
            <form action="action/update_location_fail_amount.php" method="post">
            <!-- WELCOME-->
