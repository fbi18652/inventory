<?php
    ...
    OR (`password` LIKE '%$search%') limit {$start} , {$perpage};";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="au-breadcrumb-content">
                                ...
                                <form  method="request" class="form-header" action="form_show_users.php">
                    ...
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                <h2 class="title-1">ข้อมูลผู้ใช้</h2>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <?php
                                            ...
                                            พบผลลัพธ์&nbsp;<b>
                                            <?php
                                            $count="SELECT COUNT(`users`.`username`) AS `username` FROM `users`
                                            WHERE(`username` LIKE '%$search%') 
                                            OR (`email` LIKE '%$search%') 
                                            OR (`password` LIKE '%$search%');";
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    while($row = mysqli_fetch_array($result)) { 
                                        ...
                                        if($_SESSION['username'] == !""){
                                        echo "<td><a href='form_update_users.php?username=$row[0]'><button class='btn btn-warning'>edit</button></a>
                                        <a href='action/delete_users.php?username=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\"><button class='btn btn-danger'>del</button></a></td> ";
                                        }
                                    echo "</tbody></tr>";
                                    }
                                    echo "</table>";
                                    ...
                                    <div align="center">
                                        <ul class="pagination">
                                            <?php if ($page > 1): ?>
                                            <li class="prev">
                                                <a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-1; ?>" aria-label="Previous">
                                            ...
                                            <?php if ($page > 3): ?>
                                            <li class="start"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=1">1</a></li>
                                            <li class="dots">...</li>
                                            <?php endif; ?>

                                            <?php if ($page-2 > 0): ?><li class="page"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
											<?php if ($page-1 > 0): ?><li class="page"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>
                                            <li class="currentpage">
                                                <a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page; ?>">
                                                    <?php echo $page; ?>
                                                </a>
                                            </li>

											<?php if ($page+1 < $total_page+1): ?><li class="page"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
											<?php if ($page+2 < $total_page+1): ?><li class="page"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

											<?php if ($page < $total_page-2): ?>
											<li class="dots">...</li>
											<li class="end"><a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $total_page ?>"><?php echo $total_page ?></a></li>
											<?php endif; ?>
                                            

                                            <?php if ($page < $total_page): ?>
                                            <li class="next">
                                                <a href="form_show_users.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+1;?>" aria-label="Next">
