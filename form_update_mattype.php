...
<?php
	...
	$strSQL = "SELECT * FROM mattype WHERE `type` = '".$_REQUEST['type']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Material Type</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <form action="action/update_mattype.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Matterial Type</h1>
								...
								<div class="card">
									<div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input hidden name="type2" type="text" id="type2" value="<?php echo $objResult["type"];?>" required="required" class="form-control" />
											<input name="type" type="text" id="type" value="<?php echo $objResult["type"];?>" required="required" class="form-control" />
                                        </div>
