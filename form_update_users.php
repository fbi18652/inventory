...
<?php
	...
	$strSQL = "SELECT * FROM users WHERE `username` = '".$_REQUEST['username']."' ";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Users</h1>
								...
								<div class="card">
									<div class="card-body card-block">
                                        <div class="form-group">
											...
											<input name="username" type="text" username="username" value="<?php echo $objResult["username"];?>" disabled='disabled' class="form-control" />
                                            <input name="username" type="hidden" id="username" value="<?php echo $objResult["username"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input name="email" type="email" id="email" value="<?php echo $objResult["email"];?>" required="required" class="form-control" />
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <input name="password" type="password" id="password" value="<?php echo $objResult["password"];?>" required="required" class="form-control" />
                                        </div>
