                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-lg-8 offset-md-2">
                                    ...
                                    <?php
                                        ...
                                        <form  method="request" class="form-header" action="show_mat.php">
                                            <input id="search" class="au-input au-input--xl" type="text" name="search" placeholder="กดปุ่มเพื่อแสดงข้อมูลอุปกรณ์ หรือกรอกคำค้นหา" size="control"/>
                                            <button class="au-btn--submit" type="submit" name="submit">
                                                <i class="zmdi zmdi-search"></i>
                                            </button>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if($_SESSION['username'] == !""){
                                    echo "<td><a href='form_update_mat.php?id_mat=$row[0]'><button class='btn btn-warning'>edit</button></a></td> ";
                                    //ลบข้อมูล
                                    echo "<td><a href='action/delete_mat.php?id_mat=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\"><button class='btn btn-danger'>del</button></a></td> ";
                                    }
                                    echo "</tbody></tr>";
                                    }
                                    echo "</table>";
