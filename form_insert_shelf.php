...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <form action="action/insert_shelf.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Insert new Shelf</h1>
								...
								<div class="card">
									...
									<div class="card-body card-block">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="id_shelf" name="id_shelf" placeholder="Shelf ID" required>
										</div>
										<div class="form-group">
											<label for="name">Shelf Name</label>
											<input type="text" class="form-control" id="name" name="name" placeholder="Shelf Name" required>
                                        </div>
                                        <div class="form-group">
