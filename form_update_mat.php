...
<?php
	...
	$strSQL = "SELECT * FROM mat WHERE id_mat = '".$_REQUEST['id_mat']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Material</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <form action="action/update_mat.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Matterial</h1>
								...
								<div class="card">
									...
									<div class="card-body card-block">
                                        <div class="form-group">
											<label for="id_mat">Material ID</label>
											<input name="id_mat" type="text" id="id_mat" value="<?php echo $objResult["id_mat"];?>" disabled='disabled' class="form-control" />
                                            <input name="id_mat" type="hidden" id="id_mat" value="<?php echo $objResult["id_mat"];?>" />
                                        </div>    
                                        <div class="form-group">
											<label for="describtion_mat">Matterial Description</label>
											<input name="describtion_mat" type="text" id="describtion_mat" value="<?php echo $objResult["describtion_mat"];?>" required="required" class="form-control" />
					                    </div>
                                        <div class="form-group">
											<label for="type">Material type</label>
											<select class="form-control" id="type" name="type" required>
												<option><?php echo $objResult["type"];?></option>
												<?php
													$sql="SELECT `mattype`.`type` AS `type` FROM `mattype`";
													$result=$db->query($sql);
