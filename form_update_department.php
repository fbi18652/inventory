...
<?php
	...
	$strSQL = "SELECT * FROM department WHERE `department` = '".$_REQUEST['department']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <form action="action/update_department.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Department</h1>
								...
								<div class="card">
									<div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input hidden name="department2" type="text" id="department2" value="<?php echo $objResult["department"];?>" required="required" class="form-control" />
											<input name="department" type="text" id="department" value="<?php echo $objResult["department"];?>" required="required" class="form-control" />
                                        </div>
