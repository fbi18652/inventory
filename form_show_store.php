<?php
	...
	$sql = "SELECT *
    FROM `store`
    WHERE (`id_store` LIKE '%$search%') 
    OR (`storename` LIKE '%$search%')
    OR (`id_plant` LIKE '%$search%')
    ORDER BY `id_store` ASC limit {$start} , {$perpage};";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="au-breadcrumb-content">
                                ...
                                <form  method="request" class="form-header" action="form_show_store.php">
                                    <input id="search" class="au-input au-input--xl" type="text" name="search" value="<?php echo ($search); ?>" placeholder="กดปุ่มเพื่อแสดงข้อมูลห้องสโตร์ หรือกรอกคำค้นหา" size="control"/>
                    ...
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="overview-wrap">
                                <h2 class="title-1">ข้อมูลห้องสโตร์</h2>
                                </div>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col">
                                    <div class="overview-wrap">
                                        <div class="overview-wrap">
                                            ...
                                            พบผลลัพธ์&nbsp;<b>
                                            <?php
                                            $count="SELECT COUNT(`store`.`id_store`) AS `id_store` FROM `store`
                                            WHERE (`id_store` LIKE '%$search%') 
                                            OR (`storename` LIKE '%$search%')
                                            OR (`id_plant` LIKE '%$search%')";
                                        ...
                                        <div class="btn">
                                            <div class="overview-wrap">
                                            <a href="form_insert_store.php">
                                                <button class="au-btn au-btn-icon au-btn--blue">
                                                <i class="fa fa-plus-circle"></i>Add Store</button>
                                            </a>&nbsp;
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    if($_SESSION['username'] == !""){
                                    echo "<td><a href='form_update_store.php?id_store=$row[0]'><button class='btn btn-warning'>edit</button></a>
                                    <a href='action/delete_store.php?id_store=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\"><button class='btn btn-danger'>del</button></a></td> ";
                                    }
                                    echo "</tbody></tr>";
                                    }
                                    echo "</table>";
                                    ...
                                    <div align="center">
                                        <ul class="pagination">
                                            <?php if ($page > 1): ?>
                                            <li class="prev">
                                                <a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-1; ?>" aria-label="Previous">
                                            ...
                                            <?php if ($page > 3): ?>
                                            <li class="start"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=1">1</a></li>
                                            <li class="dots">...</li>
                                            <?php endif; ?>

                                            <?php if ($page-2 > 0): ?><li class="page"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
											<?php if ($page-1 > 0): ?><li class="page"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>
                                            <li class="currentpage">
                                                <a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page; ?>">
                                                    <?php echo $page; ?>
                                                </a>
                                            </li>

											<?php if ($page+1 < $total_page+1): ?><li class="page"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
											<?php if ($page+2 < $total_page+1): ?><li class="page"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

											<?php if ($page < $total_page-2): ?>
											<li class="dots">...</li>
											<li class="end"><a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $total_page ?>"><?php echo $total_page ?></a></li>
											<?php endif; ?>
                                            

                                            <?php if ($page < $total_page): ?>
                                            <li class="next">
                                                <a href="form_show_store.php?search=<?php echo $search; ?>&submit=&page=<?php echo $page+1;?>" aria-label="Next">
