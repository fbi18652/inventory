...
<?php
	...
	$strSQL = "SELECT * FROM store WHERE id_store = '".$_REQUEST['id_store']."' ";
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Store</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
								...
								<div class="card">
									...
									<div class="card-body card-block">
                                        <div class="form-group">
											...
											<input name="id_store" type="text" id="id_store" value="<?php echo $objResult["id_store"];?>" disabled='disabled' class="form-control" />
                                            <input name="id_store" type="hidden" id="id_store" value="<?php echo $objResult["id_store"];?>" /></div>    
                                        <div class="form-group">
											<label for="storename">Store Name</label>
											<input name="storename" type="text" id="storename" value="<?php echo $objResult["storename"];?>" required="required" class="form-control" />
					                    </div>
                                        <div class="form-group">
											<label for="id_plant">Plant ID</label>
											<select class="form-control" id="id_plant" name="id_plant" required>
												<option><?php echo $objResult["id_plant"];?></option>
												<?php
													$sql="SELECT `plant`.`id` AS `id_plant` FROM `plant`";
													$result=$db->query($sql);
													while($row=$result->fetch_object())
													{
												?>
												<option value="<?php echo $row->id_plant;?>">
													<?php echo $row->id_plant;?>
												</option>
												<?php
												}
												?>   
