...
<?php
	...
	$strSQL = "SELECT * FROM plant WHERE `id` = '".$_REQUEST['id']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Plant</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <form action="action/update_plant.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Plant</h1>
								...
								<div class="card">
									<div class="card-body card-block">
                                        <div class="form-group">
											...
											<input name="id" type="text" id="id" value="<?php echo $objResult["id"];?>" disabled='disabled' class="form-control" />
                                            <input name="id" type="hidden" id="id" value="<?php echo $objResult["id"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="plant">Plant</label>
                                            <input name="plant" type="text" id="plant" value="<?php echo $objResult["plant"];?>" required="required" class="form-control" />
                                        </div>
