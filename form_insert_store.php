...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <form action="action/insert_store.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Insert new Store</h1>
								...
								<div class="card">
									...
									<div class="card-body card-block">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="id_store" name="id_store" placeholder="Store ID" required>
										</div>
										<div class="form-group">
