...
<?php
	...
	$strSQL = "SELECT * FROM employee WHERE id_emp = '".$_REQUEST['id_emp']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <form action="action/update_emp.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Employee</h1>
                            ...
                            <div  class="col">
								<div class="card">
                                    ...
                                    <div class="form-group">
											...
											<input name="id_emp" type="text" id="id_emp" value="<?php echo $objResult["id_emp"];?>" disabled='disabled' class="form-control" />
                                            <input name="id_emp" type="hidden" id="id_emp" value="<?php echo $objResult["id_emp"];?>" /></div>    
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
											...
											<select class="form-control" id="department" name="department">
												<option selected><?php echo $objResult["department"];?></option>
												<?php
													$sql="SELECT `department`.`department` AS `department` FROM `department`";
													$result=$db->query($sql);
                                        ...
                                        <div class="form-group">
											...
											<select class="form-control" id="position" name="position">
												<option selected><?php echo $objResult["position"];?></option>
												<?php
													$sql="SELECT `position`.`position` AS `position` FROM `position`";
													$result=$db->query($sql);
													while($row=$result->fetch_object())
													{
												?>
