...
<?php
	...
	$strSQL = "SELECT * FROM position WHERE `position` = '".$_REQUEST['position']."' ";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Position</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <form action="action/update_position.php" method="post">
            <!-- WELCOME-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h1 class="title-4">Update Position</h1>
								...
								<div class="card">
									<div class="card-body card-block">
                                        <div class="form-group">
                                            ...
                                            <input hidden name="position2" type="text" id="position2" value="<?php echo $objResult["position"];?>" required="required" class="form-control" />
											<input name="position" type="text" id="position" value="<?php echo $objResult["position"];?>" required="required" class="form-control" />
                                        </div>
