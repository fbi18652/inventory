                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-lg-8 offset-md-2">
                                    <div class="overview-wrap">
                                        <div class="overview-wrap">
                                            ...
                                            WHERE (`num_lo` LIKE '%$search%') 
                                            OR (`id_mat` LIKE '%$search%')
                                            OR (`id_store` LIKE '%$search%') 
                                            OR (`id_shelf` LIKE '%$search%') 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    echo "<td><a href='form_update_location_withdraw.php?num_lo=$row[0]'><button class='btn btn-warning'>withdraw</button></a></td> ";
                                    if($_SESSION['username'] == !""){
                                    //แก้ไขข้อมูลส่่ง member_id ที่จะแก้ไขไปที่ฟอร์ม
                                    echo "<td><a href='form_update_location_amount.php?num_lo=$row[0]'><button class='btn btn-warning'>edit</button></a></td> ";
                                    //ลบข้อมูล
                                    echo "<td><a href='action/delete_location.php?num_lo=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\"><button class='btn btn-danger'>del</button></a></td> ";
                                    }
                                    echo "</tbody></tr>";
                                    }
                                    echo "</table>";
